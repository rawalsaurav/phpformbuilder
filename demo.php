...
create_form($name="meroform",$fields=array($fieldab=array("name"=>"merof","type"=>"checkbox",'datas'=>$selectdata),$field2=array("name"=>"merosf","type"=>"text")),$val="Create",$task="mail");

//create_form($name="meroform",$fields=array($fieldab=array("name"=>"gender","type"=>"radio",'datas'=>$selectdata),$field2=array("name"=>"merosf","type"=>"text")),$val="Create",$MStask="mail");
