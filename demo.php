...
echo $twig->render('index.html', array('name' => 'Fabien','form'=>create_form($name="myform",$fields= array($field1=array("name"=>"mydata","type"=>"text"),$field2=array("name"=>"mydata2","type"=>"text")),$val="Done",$task="HEERE")));
